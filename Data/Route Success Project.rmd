...
```{r load_datal}
game_data <- fread("GameInfo.csv")
play_data <- fread("PlayByPlay.csv")
route_data <- fread("SkillPositionPlayers.csv")
```
...
concept_namer <- function(concept_list) {
  ...
  # Double Slant
           ...
           concept[2] %in% c("Slant", "Angle", "Curl", "Over Ball", "Pick")
           )
    return("Double Slant")
  ...
  # Spacing
  else if (concept[1] %in% c("Curl", "Dig", "Out", "Fade") &
           concept[2] == "Over Ball")
    return("Spacing")
  
  # Spot (w/ Ball Route)
  else if (concept[1] %in% c("Drag", "Over Ball", "Chip - Curl") &
  ...
  # Drive
  else if (concept[1] %in% c("Dig", "Curl", "Drag", "Over Ball") &
           concept[2] %in% c("Dig", "Curl", "Drag", "Over Ball")
           )
    return("Drive")
  ...
  # Shallow
  else if (concept[1] %in% c("Drag", "Chip - Drag") |
           concept[2] %in% c("Drag", "Chip - Drag"))
    return("Shallow")
